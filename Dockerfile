...
RUN apt-get update && apt-get install --no-install-recommends --yes temurin-17-jdk
RUN pip install --no-cache-dir git+https://github.com/coderanger/supervisor-stdout@973ba19967cdaf46d9c1634d1675fc65b9574f6e
